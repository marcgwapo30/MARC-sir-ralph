<template>
    <div class="kanban-column">
        <!-- Column Header -->
        <div class="card card-header" style="background-color: #ffa500">
            <div class="d-flex align-items-center justify-content-center">
                <i class="fas fa-spinner me-2 text-white"></i>
                <span class="header-text text-white">In Progress</span>
            </div>
        </div>
        ...
        <div class="task-list">
            <div
                ...
                "
                :class="['task-card', `pendingTask_${task.id}`]"
                    ...
                    <div class="attachment-list">
                        ...
                        >
                            <div class="attachment-preview">
                                ...
                                <template
                                    v-else-if="attachment.file_type === 'url'"
                                >
...
<style scoped>
/* Same styles as NotStartedColumn.vue */
.kanban-column {
    display: flex;
...
/* Rest of the styles same as NotStartedColumn.vue */
.task-header {
    display: flex;
